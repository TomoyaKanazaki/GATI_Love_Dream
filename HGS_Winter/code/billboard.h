...
public:	// 誰でもアクセス可能
	...
	virtual void SetPosition(const D3DXVECTOR3& pos) override { m_pos = pos; }
	virtual void SetRotation(const D3DXVECTOR3& rot) override { m_rot = rot; }

	// メンバ関数(取得)
	virtual D3DXVECTOR3 GetPosition(void) const { return m_pos; }
	virtual D3DXVECTOR3 GetRotation(void) const { return m_rot; }
